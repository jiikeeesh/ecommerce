...
const searchForm=()=>(
  ...
  <div className="col-md-3">
      <div className="key">
      <select id="agileinfo-nav_search" name="agileinfo_search" className="form-control" onChange={handleChange('category')}>
     ...
     <div className="col-md-8">
         <div className="key">
      <input name="Search" type="search" className="form-control"  onChange={handleChange('search')} required="required"/>
